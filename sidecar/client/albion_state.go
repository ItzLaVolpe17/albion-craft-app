...
type albionState struct {
	...
	// object id runtime del giocatore locale (dal NewCharacter che combacia
	// con CharacterId): serve ad attribuire combat/loot a noi. -1 = ignoto.
	LocalPlayerObjectID  int64
	GameServerIP         string
	AODataServerID       int
